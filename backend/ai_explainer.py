...
class AIIncidentExplainer:
    ...
    def explain(self, diagnosis: Dict[str, Any], steps: List[Dict[str, Any]]) -> Dict[str, Any]:
        ...
        if scenario == "database_failure":
            ...
            summary = (
                f"TraceRoot identified {initiator_name} as the root failure source with an evidence score of {score}/100. "
            ...
            summary = (
                f"TraceRoot identified {initiator_name} as the root latency initiator with an evidence score of {score}/100. "
            ...
            summary = (
                f"TraceRoot isolated {initiator_name} as the root cause with an evidence score of {score}/100. "
            ...
            summary = (
                f"TraceRoot detected an unindexed query regression in {initiator_name} with an evidence score of {score}/100. "
            ...
            summary = f"TraceRoot isolated {initiator_name} with score {score}/100."
