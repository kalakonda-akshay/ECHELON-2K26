...
class ProjectAnalyzer:
    ...
    def _evaluate_readiness(self, services: List[Dict[str, Any]], routes: List[Dict[str, Any]], compose_found: bool, dependencies_text: str, all_files: List[str]) -> Dict[str, Any]:
        ...
        if has_otel:
            ...
            checklist.append({
                ...
                "score": 0,
                "details": "OpenTelemetry SDK not detected. TraceRoot integration package required."
            })
    ...
    def _generate_integration_plan(self, project_id: str, languages: List[str], frameworks: List[str], services: List[Dict[str, Any]]) -> Dict[str, Any]:
        ...
        python_snippet = f'''# TraceRoot_instrumentation.py
# Auto-generated by TraceRoot AI for {project_id}
...
def instrument_app(app, service_name="{services[0]['id'] if services else 'my-service'}"):
    ...
    print(f"[TraceRoot AI] Telemetry active for {{service_name}} -> {collector_url}")
'''

        node_snippet = f'''// TraceRoot_tracer.js
// Auto-generated by TraceRoot AI for {project_id}
...
sdk.start();
console.log('[TraceRoot AI] OpenTelemetry instrumentation initialized for {project_id}');
'''

        files = [
            {
                "filename": "TraceRoot_instrumentation.py",
                "language": "Python",
                "code": python_snippet,
                "description": "Python FastAPI OpenTelemetry provider configuration transmitting spans to TraceRoot collector."
            },
            {
                "filename": "TraceRoot_tracer.js",
                "language": "JavaScript",
                "code": node_snippet,
                "description": "Node/Express OpenTelemetry tracing hook transmitting spans to TraceRoot collector."
            }
        ]
        ...
        return {
            ...
            "next_steps": [
                ...
                "Import TraceRoot_instrumentation and call instrument_app(app)",
                "Deploy service and observe live spans in TraceRoot topology"
            ],
            "snippets": {
