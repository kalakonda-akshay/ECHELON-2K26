...
class ProjectAnalyzer:
    ...
    def _evaluate_readiness(self, services: List[Dict[str, Any]], routes: List[Dict[str, Any]], compose_found: bool, dependencies_text: str, all_files: List[str]) -> Dict[str, Any]:
        ...
        if has_otel:
            ...
            checklist.append({
                ...
                "score": 0,
                "details": "OpenTelemetry SDK not detected. TraceLens integration package required."
            })
    ...
    def _generate_integration_plan(self, project_id: str, languages: List[str], frameworks: List[str], services: List[Dict[str, Any]]) -> Dict[str, Any]:
        ...
        python_snippet = f'''# tracelens_instrumentation.py
# Auto-generated by TraceLens AI for {project_id}
...
def instrument_app(app, service_name="{services[0]['id'] if services else 'my-service'}"):
    ...
    print(f"[TraceLens AI] Telemetry active for {{service_name}} -> {collector_url}")
'''

        node_snippet = f'''// tracelens_tracer.js
// Auto-generated by TraceLens AI for {project_id}
...
sdk.start();
console.log('[TraceLens AI] OpenTelemetry instrumentation initialized for {project_id}');
'''

        files = [
            {
                "filename": "tracelens_instrumentation.py",
                "language": "Python",
                "code": python_snippet,
                "description": "Python FastAPI OpenTelemetry provider configuration transmitting spans to TraceLens collector."
            },
            {
                "filename": "tracelens_tracer.js",
                "language": "JavaScript",
                "code": node_snippet,
                "description": "Node/Express OpenTelemetry tracing hook transmitting spans to TraceLens collector."
            }
        ]
        ...
        return {
            ...
            "next_steps": [
                ...
                "Import tracelens_instrumentation and call instrument_app(app)",
                "Deploy service and observe live spans in TraceLens topology"
            ],
            "snippets": {
