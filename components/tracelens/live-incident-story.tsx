...
export function LiveIncidentStory({
  ...
  const allEvents: StoryEvent[] = useMemo(() => {
    ...
    // -------------------------------------------------------------
    // 3. INVESTIGATION CHAPTER (TraceLens Adaptive Evidence Engine)
    // -------------------------------------------------------------
    events.push({
      id: "inv-step-1",
      timestamp: sec(12),
      service: "control-plane",
      serviceName: "TraceLens AI",
      category: "INVESTIGATION",
      priority: "P5",
      title: "TRACELENS OPENED INVESTIGATION",
      ...
      evidenceType: "TraceLens Adaptive Evidence Engine",
        ...
        {!isIncident && (
          <div className="my-6 p-6 rounded-xl bg-tl-bg/60 border border-tl-border text-center space-y-2">
            ...
            <div className="text-[10px] text-slate-500 font-mono pt-1">
              TraceLens is watching for latency threshold deviations...
            </div>
          </div>
        )}
