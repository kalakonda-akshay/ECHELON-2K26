...
export async function analyzeZipInBrowser(file: File): Promise<ProjectDetails> {
  ...
  const checklist = [
    ...
    },
    {
      ...
      details: hasPrometheus ? "Prometheus exporter verified." : "TraceRoot native collector connection required."
    },
    {
  ...
  const integration_plan: IntegrationPlan = {
    ...
    steps: [
      {
        step_number: 1,
        title: "Install TraceRoot AI OpenTelemetry Exporter",
      ...
      },
      {
        ...
        description: "Initialize tracer provider and export spans to TraceRoot collector.",
        verification: "Check collector endpoint connectivity on port 8000"
      },
      {
        step_number: 3,
        title: "Observe Real-Time Tracing",
        description: "Deploy and view live spans in TraceRoot AI interactive topology.",
        verification: "Verify green telemetry pulse in TraceRoot dashboard"
      }
    ],
    snippets: [
      {
        ...
        code: `# TraceRoot_instrumentation.py\n# Auto-generated by TraceRoot AI\nfrom opentelemetry import trace\nfrom opentelemetry.sdk.trace import TracerProvider\nfrom opentelemetry.sdk.trace.export import BatchSpanProcessor, ConsoleSpanExporter\n\nprovider = TracerProvider()\nprovider.add_span_processor(BatchSpanProcessor(ConsoleSpanExporter()))\ntrace.set_tracer_provider(provider)\nprint("[TraceRoot AI] Telemetry active")`,
